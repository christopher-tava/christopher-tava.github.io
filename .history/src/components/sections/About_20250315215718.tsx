  ...
  return (
    <>
      ...
      >
        ...
        {config.sections.about.content[8]} <br className="hidden sm:block" />
       <strong>{config.sections.about.content[9]} </strong> <br className="hidden sm:block" />
      </motion.p>
      <Header useMotion={true} p="" h2="Skills" />
