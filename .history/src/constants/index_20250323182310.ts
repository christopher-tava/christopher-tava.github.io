...
const testimonials: TTestimonial[] = [
  ...
  {
    testimonial:
      "Christopher is smart and hard-working, but it’s his curiosity and creativity that will make him a great addition to your team.",
    name: "Amaya Labrador",
    designation: "GT Alumna",
    company: "GT MentorJackets Mentor",
    image: "amaya.jpg",
  },
];
